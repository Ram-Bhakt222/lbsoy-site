...
/* =====================================================================
   PAGE: hotel-wellness
   Ported from LBSOY_Site_Build/hotel-wellness.html during the GitHub migration.
...
const PAGE_HTML = String.raw`<section class="hero">
    <div class="hero-inner">
      <div class="hero-content">
        <div class="hero-badge">For Hotel GMs & Hospitality Directors</div>
        <h1>Elevate Your Guest <em>Experience</em> with Yoga</h1>
        <p class="hero-sub">Premium wellness amenities that differentiate your property and drive guest satisfaction. In-room yoga, poolside classes, spa integration, and custom wellness packages. Staffed by My Yoga Network professionals.</p>
        <div class="hero-actions">
          <a href="#cta-form" class="btn-primary">
            Explore Hotel Wellness Packages
      ...
      <div>
        <div class="hero-image-placeholder">Poolside yoga session at luxury hotel</div>
        <div class="hero-float-card">
          <div class="hero-float-number">4.8</div>
          <div class="hero-float-label"><strong>Star</strong>Guest Ratings</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-alt">
    <div class="section-inner">
      <div class="section-header">
        ...
        <h2>Wellness Tourism & Guest Differentiation</h2>
        <p>Modern guests expect wellness amenities as a key hotel feature.</p>
      </div>
      <div class="problem-grid">
        <div class="problem-card">
          <h3>Wellness Demand</h3>
          <p>76% of travelers seek wellness experiences when choosing hotels. Without yoga and wellness offerings, you're losing competitive advantage.</p>
        </div>
        <div class="problem-card">
          <h3>Premium Pricing</h3>
          <p>Hotels offering wellness amenities command 15-25% higher room rates and attract affluent, loyal guests seeking holistic experiences.</p>
        </div>
        <div class="problem-card">
          <h3>Staffing Challenges</h3>
          <p>Finding qualified yoga instructors and wellness staff is difficult. A reliable partner ensures consistent, professional service.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <h2>Premium Guest Wellness Amenities</h2>
        <p>Complete yoga and wellness programs staffed by My Yoga Network professionals.</p>
      </div>
      <div class="solution-grid">
        <div class="solution-card">
          ...
          <h3>In-Room Yoga Services</h3>
          <p>Private yoga sessions delivered to guest rooms. Perfect for executives, wellness-focused travelers, and those with limited mobility.</p>
        </div>
        <div class="solution-card">
          <div class="solution-icon">
            <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
          </div>
          <h3>Poolside & Outdoor Classes</h3>
          <p>Sunrise and sunset yoga sessions by the pool or on the patio. Photo-worthy moments that guests share on social media.</p>
        </div>
        <div class="solution-card">
          <div class="solution-icon">
            <svg viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><circle cx="17" cy="9" r="4"/></svg>
          </div>
          <h3>Spa Integration & Packages</h3>
          <p>Yoga-spa wellness packages bundled with massage and beauty services. Premium add-ons that increase room revenue significantly.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-alt">
    <div class="section-inner">
      <div class="benefits-two-col">
        <div id="benefits">
          <h2 style="font-family: var(--font-heading); font-size: 40px; font-weight: 600; color: var(--charcoal); line-height: 1.15; margin-bottom: 40px;">Why Hotels Choose LBSOY</h2>
          <ul class="benefits-list">
            <li>Differentiate from competitors with premium wellness</li>
            <li>Higher guest satisfaction scores and ratings</li>
            <li>15-25% premium pricing for rooms with wellness</li>
            <li>Increased ancillary revenue from add-on services</li>
            <li>Positive online reviews and word-of-mouth</li>
            <li>Attract affluent, high-value guests seeking wellness</li>
            <li>Professional staffing through My Yoga Network</li>
            <li>Repeat bookings and enhanced guest loyalty</li>
          </ul>
        </div>
        <div class="benefits-image">Photo: Luxury hotel wellness amenities</div>
      </div>
    </div>
  </section>
    ...
    <div class="section-inner">
      <div class="stats-grid">
        <div class="stat-card">
          ...
          <div class="stat-label">Guests Want Wellness</div>
        </div>
        <div class="stat-card">
          <div class="stat-number">20%</div>
          <div class="stat-label">More Likely Return</div>
        </div>
        <div class="stat-card">
          <div class="stat-number">25%</div>
          <div class="stat-label">Higher Rates</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-alt">
    <div class="section-inner">
      <div class="section-header">
        ...
        <h2>How Our Hotel Programs Work</h2>
      </div>
      <div class="how-it-works">
        <div class="how-card">
          <div class="how-number">1</div>
          <h3>Property Assessment</h3>
          <p>We evaluate your property, guest demographics, space availability, and wellness goals to design the perfect program.</p>
        </div>
        <div class="how-card">
          <div class="how-number">2</div>
          <h3>Custom Program Design</h3>
          <p>We create a tailored wellness menu: in-room services, group classes, spa integration, and signature packages for your guests.</p>
        </div>
        <div class="how-card">
          <div class="how-number">3</div>
          <h3>Professional Staffing</h3>
          <p>My Yoga Network professionals deliver consistent, world-class instruction. We handle all staffing, scheduling, and quality control.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="section-inner">
      <div class="form-section" id="cta-form">
        <h2>Explore Hotel Wellness Packages</h2>
        <form onsubmit="return handleFormSubmit(event)">
          <div class="form-group">
            <label for="name">Your Name</label>
            <input type="text" id="name" name="name" placeholder="John Martinez" required>
          </div>
          <div class="form-group">
            <label for="email">Email Address</label>
            <input type="email" id="email" name="email" placeholder="john@hotel.com" required>
          </div>
          <div class="form-group">
            <label for="organization">Property Name</label>
            <input type="text" id="organization" name="organization" placeholder="The Long Beach Resort" required>
          </div>
          <div class="form-group">
            <label for="role">Your Role</label>
            <input type="text" id="role" name="role" placeholder="General Manager" required>
          </div>
          <div class="form-group">
            <label for="message">Tell Us About Your Property</label>
            <textarea id="message" name="message" placeholder="Number of rooms, guest profile, amenities, specific wellness interests..."></textarea>
          </div>
          <button type="submit" class="form-submit">Request Wellness Package Details</button>
        </form>
      </div>
    </div>
  </section>
  ...
  <section class="cta-banner">
    <h2>Premium Wellness That Guests Will Love</h2>
    <p>Differentiate your hotel and boost guest satisfaction with professional yoga and wellness amenities.</p>
  ...
  <script>
    function handleFormSubmit(e) {
      e.preventDefault();
      alert('Thank you! We will contact you shortly with detailed wellness package options for your property.');
      e.target.reset();
      return false;
    }
  </script>`;
...
const PAGE_SCHEMA = {
    ...
    "@type": "LocalBusiness",
    "name": "Long Beach School of Yoga - Hotel Wellness Programs",
    "description": "Premium yoga and wellness services for Long Beach hotels. Guest wellness packages and amenities.",
    "url": "https://longbeachschoolofyoga.com/hotel-wellness",
    "address": {
      "@type": "PostalAddress",
...
export const metadata: Metadata = buildMetadata({
  title: 'Hotel Yoga & Wellness Services Long Beach | Guest Experience',
  description: 'Premium yoga and wellness services for Long Beach hotels. In-room yoga, poolside classes, spa integration, and guest wellness packages to enhance the guest experience.',
  path: "/hotel-wellness",
  keywords: ["hotel yoga", "wellness tourism", "guest experience", "hospitality wellness", "resort yoga programs long beach"],
});
