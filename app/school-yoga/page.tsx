...
/* =====================================================================
   PAGE: school-yoga
   Ported from LBSOY_Site_Build/school-yoga.html during the GitHub migration.
...
const PAGE_HTML = String.raw`<section class="hero">
    <div class="hero-inner">
      <div class="hero-content">
        <div class="hero-badge">For School Administrators & Counselors</div>
        <h1>Bring Calm and <em>Focus</em> to Your Classroom</h1>
        <p class="hero-sub">Age-appropriate yoga and mindfulness programs that reduce student anxiety, improve focus, and support teacher wellness. Evidence-based curriculum for K-12 schools.</p>
      ...
      <div>
        <div class="hero-image-placeholder">Students practicing mindfulness in classroom</div>
        <div class="hero-float-card">
          <div class="hero-float-number">40%</div>
          <div class="hero-float-label"><strong>Reduced</strong>Anxiety</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-alt">
    <div class="section-inner">
      <div class="section-header">
        ...
        <h2>Student Stress and Behavioral Challenges</h2>
        <p>Today's students face unprecedented levels of anxiety and distraction.</p>
      </div>
      <div class="problem-grid">
        <div class="problem-card">
          <h3>Student Anxiety</h3>
          <p>42% of school-age children report anxiety disorders. Students struggle to focus and manage emotions in class.</p>
        </div>
        <div class="problem-card">
          <h3>Behavioral Issues</h3>
          <p>Lack of emotional regulation leads to classroom disruption, disciplinary incidents, and suspended instruction time.</p>
        </div>
        <div class="problem-card">
          <h3>Teacher Burnout</h3>
          <p>Teachers face increasing stress managing emotional and behavioral challenges. Burnout affects instructor retention and classroom quality.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <h2>Evidence-Based Yoga & Mindfulness Curriculum</h2>
        <p>Age-appropriate programs designed for student development and teacher support.</p>
      </div>
      <div class="solution-grid">
        <div class="solution-card">
          <div class="solution-icon">
            <svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.5 11c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 10 8.5 10 7 10.67 7 11.5 7.67 13 8.5 13z"/></svg>
          </div>
          <h3>K-12 Age-Appropriate Classes</h3>
          <p>Curriculum tailored to elementary, middle, and high school students. Engaging, relatable instruction that meets students where they are developmentally.</p>
        </div>
        <div class="solution-card">
          <div class="solution-icon">
            <svg viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>
          </div>
          <h3>Mindfulness Curriculum</h3>
          <p>Research-backed breathing, meditation, and emotional regulation techniques. Teaches students coping skills for stress and anxiety management.</p>
        </div>
        <div class="solution-card">
          <div class="solution-icon">
            <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
          </div>
          <h3>Teacher Wellness Programs</h3>
          <p>Dedicated sessions and self-care practices for educators. Reduces staff stress and improves classroom management capacity.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-alt">
    <div class="section-inner">
      <div class="benefits-two-col">
        <div id="benefits">
          <h2 style="font-family: var(--font-heading); font-size: 40px; font-weight: 600; color: var(--charcoal); line-height: 1.15; margin-bottom: 40px;">Why Schools Choose LBSOY</h2>
          <ul class="benefits-list">
            <li>40% reduction in student anxiety and stress</li>
            <li>Improved academic focus and concentration</li>
            <li>Fewer behavioral incidents and disciplinary actions</li>
            <li>Better test performance and attendance</li>
            <li>Enhanced emotional regulation skills</li>
            <li>Stronger peer relationships and classroom community</li>
            <li>Teacher retention and reduced burnout</li>
            <li>Positive school climate and culture</li>
          </ul>
        </div>
        <div class="benefits-image">Photo: School yoga session with students</div>
      </div>
    </div>
  </section>
    ...
    <div class="section-inner">
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-label">Better Focus</div>
        </div>
        <div class="stat-card">
  ...
  <section class="section section-alt">
    <div class="section-inner">
      <div class="section-header">
        ...
        <h2>How Our School Programs Work</h2>
      </div>
      <div class="how-it-works">
        <div class="how-card">
          <div class="how-number">1</div>
          <h3>Assessment</h3>
          <p>We meet with administrators, teachers, and counselors to understand school needs, student demographics, and goals.</p>
        </div>
        <div class="how-card">
          <div class="how-number">2</div>
          <h3>Curriculum Design</h3>
          <p>We create a customized yoga and mindfulness program integrated into your school schedule and existing curriculum.</p>
        </div>
        <div class="how-card">
          <div class="how-number">3</div>
          <h3>Implementation & Support</h3>
          <p>Regular classes, teacher training, and ongoing support to ensure student engagement and measurable outcomes.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="section-inner">
      <div class="form-section" id="cta-form">
        <h2>Request Your School Program Proposal</h2>
        <form onsubmit="return handleFormSubmit(event)">
          ...
          <div class="form-group">
            <label for="organization">School Name</label>
            <input type="text" id="organization" name="organization" placeholder="Lincoln High School" required>
          </div>
          <div class="form-group">
            <label for="role">Your Role</label>
            <input type="text" id="role" name="role" placeholder="PE Director / School Counselor" required>
          </div>
          <div class="form-group">
            <label for="message">Tell Us About Your School's Needs</label>
            <textarea id="message" name="message" placeholder="Grade levels, student population, specific challenges, schedule preferences..."></textarea>
          </div>
          <button type="submit" class="form-submit">Request Program Proposal</button>
        </form>
      </div>
    </div>
  </section>
  ...
  <section class="cta-banner">
    <h2>Support Your Students' Emotional Growth</h2>
    <p>Bring evidence-based yoga and mindfulness to your school. Request a customized program proposal today.</p>
  ...
  <script>
    function handleFormSubmit(e) {
      e.preventDefault();
      alert('Thank you! We will contact you soon with a customized school program proposal.');
      e.target.reset();
      return false;
    }
  </script>`;
...
const PAGE_SCHEMA = {
    ...
    "@type": "LocalBusiness",
    "name": "Long Beach School of Yoga - School Programs",
    "description": "Yoga and mindfulness programs for K-12 schools in Long Beach.",
    "url": "https://longbeachschoolofyoga.com/school-yoga",
    "address": {
      "@type": "PostalAddress",
...
export const metadata: Metadata = buildMetadata({
  title: 'Yoga for Schools Long Beach | Student Wellness Programs',
  description: 'Yoga and mindfulness programs for K-12 schools in Long Beach. Improve student focus, reduce anxiety, and support teacher wellness with evidence-based yoga curriculum.',
  path: "/school-yoga",
  keywords: ["yoga for schools", "student wellness", "mindfulness in schools", "school yoga programs", "youth yoga long beach"],
});
